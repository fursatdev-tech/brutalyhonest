...
import { getTourDestinations } from "@/util/routes";
...
const Step5 = ({ data, setData }: StepProps) => {
    ...
    const destinations = rawDestinations.data as Destination[];
    ...
    return (
        <div className="space-y-8">
            ...
            <ScrollArea className="relative w-full h-[60vh]">
